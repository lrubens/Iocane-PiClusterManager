    ...
    RGraph.Radar = function (conf)
    {
        ...
        */
        ...
        /*
            ...
            'chart.axes.tickmarks.count':        'chart.axes.numticks',
            'chart.axes.capped':                 'chart.axes.caps',
        ...
        */
        ...
        this.properties =
        {
            ...
            'chart.colors.stroke':           '#aaa',
            'chart.colors':                ['rgba(255,0,0,0.75)','rgba(0,255,255,0.25)','rgba(255,0,0,0.5)', 'red', 'green', 'blue', 'pink', 'aqua','brown','orange','grey'],
            ...
            'chart.labels.axes.boxed.background': 'rgba(255,255,255,0.7)',
            'chart.labels.axes.specific':   null,
        ...
        this.Draw = function ()
        {
            ...
            */
            if (RG.isNull(prop['chart.labels.axes.boxed'])) {
                ...
                for (var i=0; i<( (RG.isArray(prop['chart.labels.axes.specific']) && prop['chart.labels.axes.specific'].length) || prop['chart.labels.axes.count'] || 5); ++i) {
            ...
            */
            ...
            if (!prop['chart.scale.max']) {
                ...
                this.scale2 = RG.getScale2(this, {
                    'scale.max':          typeof prop['chart.scale.max'] === 'number' ? prop['chart.scale.max'] : this.max,
                    'scale.min':          0,
            ...
            */
            if ( (prop['chart.fill.click'] || prop['chart.fill.mousemove'] || !RG.isNull(prop['chart.fill.tooltips'])) && !this.__fill_click_listeners_installed__) {
            ...
            */
            if (prop['chart.background.circles'] && poly == false) {
               ...
               co.beginPath();
                    ...
                    var numrings = typeof(prop['chart.background.circles.count']) == 'number' ? prop['chart.background.circles.count'] : prop['chart.labels.axes.count'];
                    ...
                    co.beginPath();
                        for (var a=0; a<=360; a+=(360 / this.data[0].length)) {
                            co.arc(
                                ...
                                this.centery,
                                r,
                                RG.toRadians(a) - RG.HALFPI,
                                RG.toRadians(a) + 0.001 - RG.HALFPI,
                                false
                            );
                        }
                    co.closePath();
        ...
        */
        ...
        this.DrawAxes = function ()
        {
            ...
            co.lineWidth   = prop['chart.axes.linewidth'];
            ...
            co.beginPath();
                ...
                */
                ...
                for (var y=(this.centery - this.radius); y<(this.centery + this.radius); y+=(this.radius/prop['chart.yaxis.tickmarks.count'])) {
                ...
                */
                ...
                for (var x=(this.centerx - this.radius); x<(this.centerx + this.radius); x+=(this.radius/prop['chart.xaxis.tickmarks.count'])) {
            ...
            for (var dataset=0; dataset<this.data.length; ++dataset) {
                ...
                co.beginPath();
                    ...
                    */
                    ...
                    co.strokeStyle = (typeof(prop['chart.colors.stroke']) == 'object' && prop['chart.colors.stroke'][dataset]) ? prop['chart.colors.stroke'][dataset] : prop['chart.colors.stroke'];
        ...
        */
        ...
        this.DrawAxisLabels = function ()
        {
            ...
            */
            if (RG.isArray(prop['chart.labels.axes.specific']) && prop['chart.labels.axes.specific'].length) {
        ...
        */
        ...
        this.DrawSpecificAxisLabels = function ()
        {
            ...
            */
            var labels          = prop['chart.labels.axes.specific'];
            var bold            = RG.arrayPad(prop['chart.labels.axes.bold'],labels.length);
            var boxed           = RG.arrayPad(prop['chart.labels.axes.boxed'],labels.length);
            var reversed_labels = RG.arrayReverse(labels);
            var reversed_bold   = RG.arrayReverse(bold);
            var reversed_boxed  = RG.arrayReverse(boxed);
            ...
            for (var i=0; i<labels.length; ++i) {
                ...
                if (axes.indexOf('n') > -1) RG.text2(this, {font: textConf.font,size: textConf.size,color: textConf.color,bold: textConf.bold,italic: textConf.italic,tag: 'labels.axes.specific', x:this.centerx,y:this.centery - this.radius + ((this.radius / labels.length) * i),text:reversed_labels[i],valign:'center',halign:'center',bounding:reversed_boxed[i],boundingFill:'white'});
                if (axes.indexOf('s') > -1) RG.text2(this, {font: textConf.font,size: textConf.size,color: textConf.color,bold: textConf.bold,italic: textConf.italic,tag: 'labels.axes.specific', x:this.centerx,y:this.centery + ((this.radius / labels.length) * (i+1)),text:labels[i],valign:'center',halign:'center',bounding:boxed[i],boundingFill:'white'});
                
                if (axes.indexOf('w') > -1) RG.text2(this, {font: textConf.font,size: textConf.size,color: textConf.color,bold: textConf.bold,italic: textConf.italic,tag: 'labels.axes.specific', x:this.centerx - this.radius + ((this.radius / labels.length) * i),y:this.centery,text:reversed_labels[i],valign:'center',halign:'center',bounding:reversed_boxed[i],boundingFill:'white'});
                if (axes.indexOf('e') > -1) RG.text2(this, {font: textConf.font,size: textConf.size,color: textConf.color,bold: textConf.bold,italic: textConf.italic,tag: 'labels.axes.specific', x:this.centerx + ((this.radius / labels.length) * (i+1)),y:this.centery,text:labels[i],valign:'center',halign:'center',bounding:boxed[i],boundingFill:'white'});
            }
        };
                ...
                for (var dataset=0; dataset <this.data.length; ++dataset) {
                    for (var index=0; index<this.data[dataset].length; ++index) {
                        co.beginPath();
                            ...
                            co.fillStyle = prop['chart.highlights.fill'] ? prop['chart.highlights.fill'] : ((typeof(prop['chart.colors.stroke']) == 'object' && prop['chart.colors.stroke'][dataset]) ? prop['chart.colors.stroke'][dataset] : prop['chart.colors.stroke']);
        ...
        */
        this.parseColors = function ()
        {
            ...
            if (this.original_colors.length === 0) {
                ...
                this.original_colors['chart.labels.color']     = RG.arrayClone(prop['chart.labels.color']);
                this.original_colors['chart.labels.axes.color']= RG.arrayClone(prop['chart.labels.axes.color']);
                ...
                this.original_colors['chart.circle.fill']      = RG.arrayClone(prop['chart.circle.fill']);
                this.original_colors['chart.circle.stroke']    = RG.arrayClone(prop['chart.circle.stroke']);
            ...
            prop['chart.labels.color']     = this.parseSingleColorForGradient(prop['chart.labels.color']);
            prop['chart.labels.axes.color']= this.parseSingleColorForGradient(prop['chart.labels.axes.color']);
            ...
            if (typeof prop['chart.colors.stroke'] === 'object') {
                for (var i=0; i<prop['chart.colors.stroke'].length; ++i) {
                    prop['chart.colors.stroke'][i] = this.parseSingleColorForGradient(prop['chart.colors.stroke'][i]);
                }
            } else {
        ...
        */
        ...
        this.AddFillListeners = function (e)
        {
            ...
            */
            if (prop['chart.fill.mousemove'] || !RG.isNull(prop['chart.fill.tooltips'])) {
        ...
        */
        this.trace = function ()
        {
            ...
            obj.set('chart.animation.trace.clip', 0);
            ...
            var iterator = function ()
            {
                if (frame < frames) {
                    ...
                    obj.set('chart.animation.trace.clip', frame / frames);
                    ...
                    obj.set('chart.animation.trace.clip', 1);
                    RG.redrawCanvas(obj.canvas);
                    callback(obj);
                }
            };
