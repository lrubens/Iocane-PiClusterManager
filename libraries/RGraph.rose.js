    ...
    RGraph.Rose = function (conf)
    {
        ...
        */
        ...
        this.propertyNameAliases = {
            /*
            'chart.axes':                        'chart.background.axes',
            'chart.axes.color':                  'chart.background.axes.color',
            ...
            'chart.scale.size':                  'chart.text.size.scale',
            'chart.scale.max':                   'chart.ymax',
            'chart.labels.axes.count':           'chart.labels.count',
            'chart.labels.axes.boxed':           'chart.labels.boxed',
        ...
        */
        ...
        this.Draw = function ()
        {
            ...
            */
            ...
            this.radius       = (ma.min(ca.width - this.marginLeft - this.marginRight, ca.height - this.marginTop - this.marginBottom) / 2);
        ...
        */
        ...
        this.DrawBackground = function ()
        {
            ...
            if (prop['chart.background.grid.circles.count']) {
                
                if (typeof(prop['chart.background.grid.circles.count']) == 'number') {
                    prop['chart.background.grid.circles.size'] = this.radius / prop['chart.background.grid.circles.count'];
                }
                ...
                co.beginPath();
                    ...
                    for (var i=prop['chart.background.grid.circles.size']; i<=this.radius; i+=prop['chart.background.grid.circles.size']) {
                ...
                if (typeof prop['chart.background.grid.radials.count'] !== 'number') {
                    prop['chart.background.grid.radials.count'] = this.data.length
                }
                
                if (prop['chart.background.grid.radials.count'] > 0) {

                    var num = (360 / prop['chart.background.grid.radials.count']);
        ...
        */
        ...
        this.DrawRose = function ()
        {
            var max    = 0,
                data   = this.data,
                margin = RG.toRadians(prop['chart.margin']),
                opt    = arguments[0] || {};

            co.lineWidth = prop['chart.linewidth'];
    
            // Work out the maximum value and the sum
            if (RG.isNull(prop['chart.scale.max'])) {
            ...
            *******************************************************/
            if (typeof(prop['chart.variant']) == 'string' && prop['chart.variant'].indexOf('non-equi-angular') !== -1) {
                ...
                for (var i=0; i<this.data.length; ++i) {
                    ...
                    var radius         = ((this.data[i][0] - prop['chart.scale.min']) / (this.max - prop['chart.scale.min'])) * this.radius;
                    ...
                    if (typeof this.data[i] == 'number') {
                        co.beginPath(); // Begin the segment
                            ...
                            *******************************************************/
                            ...
                            var radius = ((this.data[i] - prop['chart.scale.min']) / (this.max - prop['chart.scale.min'])) * this.radius;
                                radius = radius * prop['chart.animation.grow.multiplier'];
                    ...
                    *******************************************************/
                        ...
                        for (var j=0; j<this.data[i].length; ++j) {
                            ...
                            if (j == 0) {
                                co.beginPath(); // Begin the segment
                                    var startRadius = 0;
                                    var endRadius = ((this.data[i][j] - prop['chart.scale.min']) / (this.max - prop['chart.scale.min'])) * this.radius;
                                ...
                                co.beginPath(); // Begin the segment
                                    ...
                                    var endRadius = (((this.data[i][j] - prop['chart.scale.min']) / (this.max - prop['chart.scale.min'])) * this.radius) + startRadius;
                                        endRadius = endRadius * prop['chart.animation.grow.multiplier'];
        ...
        */
        ...
        this.DrawLabels = function ()
        {
            ...
            if (typeof(prop['chart.text.size']) == 'number') {
                size = prop['chart.text.size'];
            }
            ...
            if (axes.indexOf('n') > -1) {
                ...
                for (var i=0; i<prop['chart.labels.axes.count']; ++i) {
                    RG.text2(this, {
                   ...
                   italic: textConf.italic,
                        ...
                        'x':centerx + offset,
                        'y':centery - (radius * ((i+1) / prop['chart.labels.axes.count'])),
            ...
            if (axes.indexOf('e') > -1) {
                for (var i=0; i<prop['chart.labels.axes.count']; ++i) {
                   ...
                   italic: textConf.italic,
                        ...
                        'x':centerx + (radius * ((i+1) / prop['chart.labels.axes.count'])),
                        'y':centery + offset,
                        'text':this.scale2.labels[i],
                        'valign':valign,
                        'halign':'center',
            ...
            if (RG.trim(axes).length > 0) {
               ...
               italic: textConf.italic,
                    ...
                    'x':centerx,
                    'y':centery,
                    'text':typeof prop['chart.scale.min'] === 'number' ?
                               RG.numberFormat({
                                   object:    this,
                                   number:    Number(prop['chart.scale.min']).toFixed(prop['chart.ymin'] === 0 ? '0' : prop['chart.scale.decimals']),
                                   unitspre:  units_pre,
        ...
        */
        this.explode = function ()
        {
            ...
            var exploded    = Number(this.get('chart.exploded'));
        ...
        */
        ...
        this.roundRobin = function ()
        {
            ...
            function iterator ()
            {
                ...
                if (frame++ < frames) {
                    obj.set('chart.animation.roundrobin.factor', frame / frames);
                    obj.set('chart.margin', (frame / frames) * original_margin);
                    RG.Effects.updateCanvas(iterator);
                } else {
        ...
        */
        this.grow = function ()
        {
            ...
            function iterator ()
            {
                obj.set('chart.animation.grow.multiplier', frame / frames);
