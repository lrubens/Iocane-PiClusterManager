    ...
    RG.SVG.Scatter = function (conf)
    {
        ...
        */
        ...
        this.propertyNameAliases = {
            ...
            //xaxisScaleFormatter: 'xaxisFormatter',
        ...
        */
        ...
        if (typeof prop.xaxisScaleMin === 'string') {
            prop.xaxisScaleMin = RG.SVG.parseDate(prop.xaxisScaleMin);
        }

        if (typeof prop.xaxisScaleMax === 'string') {
            prop.xaxisScaleMax = RG.SVG.parseDate(prop.xaxisScaleMax);
        }
