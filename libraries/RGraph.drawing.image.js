    ...
    RGraph.Drawing.Image = function (conf)
    {
        ...
        */
        ...
        this.propertyNameAliases = {
            ...
            //'chart.colors.alpha':       'chart.alpha'
            /* [NEW]:[OLD] */
        };
        ...
        */
        this.parseColors = function ()
        {
            ...
            if (this.original_colors.length === 0) {
                this.original_colors['chart.colors.background'] = RG.arrayClone(prop['chart.colors.background']);
            ...
            */
            prop['chart.colors.background'] = this.parseSingleColorForGradient(prop['chart.colors.background']);
