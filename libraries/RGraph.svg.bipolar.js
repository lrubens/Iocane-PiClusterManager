    ...
    RG.SVG.Bipolar = function (conf)
    {
        ...
        */
        ...
        this.propertyNameAliases = {
            ...
            //marginCenter:        'gutterCenter',
            //colorsStroke:        'strokestyle',
            //xaxisScaleUnitsPre:  'xaxisUnitsPre',
            //xaxisScaleUnitsPost: 'xaxisUnitsPost',
            //xaxisScaleDecimals:  'xaxisDecimals',
            //xaxisScalePoint:     'xaxisPoint',
            //xaxisScaleThousand:  'xaxisThousand',
            //xaxisScaleRound:     'xaxisRound',
            //xaxisScaleMax:       'xaxisMax',
            //xaxisScaleMin:       'xaxisMin'
            /* [NEW]:[OLD] */
        };
        ...
        */
        ...
        this.drawLabels = function ()
        {
            ...
            var y   = this.height - prop.marginBottom + 10,
                str = (prop.xaxisScaleUnitsPre + prop.xaxisScaleMin.toFixed(prop.xaxisScaleDecimals).replace(/\./, prop.xaxisScalePoint) + prop.xaxisScaleUnitsPost);
            ...
            var text = RG.SVG.text({
                object: this,
                parent: this.svg.all,
                text:   prop.xaxisScaleUnitsPre + prop.xaxisScaleMin.toFixed(prop.xaxisScaleDecimals).replace(/\./, prop.xaxisScalePoint) + prop.xaxisScaleUnitsPost,
        ...
        this.drawBars = function ()
        {
            ...
            for (var i=0; i<this.left.length; ++i) {
                ...
                if (typeof this.left[i] === 'number') {
                    ...
                    var color   = prop.colors[this.sequentialIndex],
                        ...
                        y       = prop.marginTop + ((this.graphHeight / this.left.length) * i) + prop.vmargin,
                ...
                // LEFT STACKED
                    ...
                    for (var j=0; j<this.left[i].length; ++j) {
                        ...
                        if (j === 0 && prop.shadow) {
                            ...
                            var shadowBackfaceX = prop.marginLeft + this.graphWidth - this.getWidth(RG.SVG.arraySum(this.left[i])),
                ...
                // LEFT GROUPED
                    ...
                    for (var j=0; j<this.left[i].length; ++j) {
                        ...
                        var color    = prop.colors[this.sequentialIndex],
                            ...
                            y        = prop.marginTop + ((this.graphHeight / this.left.length) * i) + prop.vmargin + (height * j) + (j * prop.vmarginGrouped),
                            width    = this.getWidth(this.left[i][j]),
                            x        = prop.marginLeft + this.graphWidth - width;
            ...
            for (var i=0; i<this.right.length; ++i) {
                ...
                if (typeof this.right[i] === 'number') {
                    ...
                    var color   = prop.colors[this.sequentialIndex],
                        tooltip = RG.SVG.isNull(prop.tooltips) ? null : prop.tooltips[this.sequentialIndex],
                        y       = prop.marginTop + ((this.graphHeight / this.right.length) * i) + prop.vmargin,
                ...
                // RIGHT GROUPED
                    ...
                    for (var j=0; j<this.right[i].length; ++j) {
                        ...
                        var color    = prop.colors[this.sequentialIndex],
                            ...
                            y        = prop.marginTop + ((this.graphHeight / this.right.length) * i) + prop.vmargin + (height * j) + (j * prop.vmarginGrouped),
                            width    = this.getWidth(this.right[i][j]),
                            x        = prop.marginLeft + this.graphWidth + prop.marginCenter;
            ...
            if (prop.labelsAbove) {
                ...
                for (var dataset=0,seq=0; dataset<this.data.length; ++dataset,++seq) {
                    for (var i=0; i<this.data[dataset].length; ++i,++seq) {
                        ...
                        // STACKED CHART
                        } else if (!RG.SVG.isNull(value) && typeof value === 'object' && prop.grouping === 'stacked') {
                        ...
                        // GROUPED CHART
                        } else if (!RG.SVG.isNull(value) && typeof value === 'object' && prop.grouping === 'grouped') {
                            ...
                            for (var k=0; k<value.length; ++k) {
                                ...
                                if (val === 0 || RG.SVG.isNull(val) || val === '') {                                    
                                    str = '';
                                }
