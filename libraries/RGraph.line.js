                ...
                */
                ...
                for (i=0; i<numLabels; ++i) {
                    ...
                    if (prop['chart.xaxis.labels'][i]) {
                        ...
                        var labelX = ((ca.width - this.marginLeft - this.marginRight - (2 * prop['chart.hmargin'])) / (numLabels - 1) ) * i;
                            labelX += this.marginLeft + prop['chart.hmargin'];
        ...
        */
        ...
        this.DrawLine = function (lineData, color, fill, linewidth, tickmarks, index)
        {
            ...
            */
            ...
            var xInterval = (ca.width - (2 * prop['chart.hmargin']) - this.marginLeft - this.marginRight) / (lineData.length - 1);
            ...
            for (i=0,len=lineData.length; i<len; i+=1) {
                ...
                */
                ...
                if (i > 0) {
                    ...
                    xPos = prop['chart.hmargin'] + this.marginLeft;
                }
