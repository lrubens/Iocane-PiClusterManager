        ...
        */
        this.parseColors = function ()
        {
            ...
            if (this.original_colors.length === 0) {
                this.original_colors['chart.colors.fill']      = RG.array_clone(prop['chart.colors.fill']);
            ...
            */
            prop['chart.colors.fill']      = func(prop['chart.colors.fill']);
            prop['chart.colors.stroke']    = func(prop['chart.colors.stroke']);
