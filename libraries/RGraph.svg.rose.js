    ...
    RG.SVG.Rose = function (conf)
    {
        ...
        */
        ...
        this.draw = function ()
        {
            ...
            if (typeof prop.amargin === 'string' && prop.amargin.match(/([0-9.]+)deg/)) {
                prop.amargin = RegExp.$1 / (180 / ma.PI);
            }
        ...
        this.drawLabels = function ()
        {
            ...
            for (var i=0; i<prop.labels.length; ++i) {
                ...
                if (prop.variant === 'non-equi-angular') {
                    var angle  = ((Number(this.angles2[i][0].element.getAttribute('data-end-angle')) - Number(this.angles2[i][0].element.getAttribute('data-start-angle'))) / 2) + Number(this.angles2[i][0].element.getAttribute('data-start-angle')) - RG.SVG.TRIG.HALFPI;
                } else {
                ...
                var explosion = this.getExploded({
                    index: i,
                    start: Number(this.angles2[i][0].element.getAttribute('data-start-angle')) - RG.SVG.TRIG.HALFPI,
                    end: Number(this.angles2[i][0].element.getAttribute('data-end-angle')) - RG.SVG.TRIG.HALFPI
                });
        ...
        */
        this.highlight = function (path)
        {
            ...
            var arcPath = RG.SVG.TRIG.getArcPath3({
                cx:     centerx,
                cy:     centery,
                r:      radius,
                start:  start,
            ...
            var arcPath_array = RG.SVG.TRIG.getArcPath3({
                cx:     centerx,
                cy:     centery,
                r:      radius,
                start:  start,
