    ...
    RG.SVG.Waterfall = function (conf)
    {
        ...
        this.set = function (name, value)
        {
            if (arguments.length === 1 && typeof name === 'object') {
                ...
                //
                var tmp = RG.SVG.propertyNameAlias({object:this, name:name, value:value});
                name    = tmp.name;
                value   = tmp.value;
        ...
        */
        this.get = function (name)
        {
            ...
            // inline with the SVG charts.
            //
            var tmp = RG.SVG.propertyNameAlias({object: this, name:  name});
            name    = tmp.name;
        ...
        this.propertyNameAliases = {
            ...
            //colorsConnector:        'strokestyleConnector',
        ...
        */
        ...
        this.drawBars = function ()
        {
            ...
            for (var i=0; i<(this.data.length); ++i) {
                ...
                var x = prop.marginLeft + (outerWidth * i) + prop.hmargin;
