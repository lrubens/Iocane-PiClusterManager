    ...
    RGraph.AllowResizing = function (obj)
    {
        ...
        */
        ...
        if (   !ca.resizing.__rgraph_original_width__
            ...
            ca.resizing.adjustX = (typeof obj.get('chart.resizable.handle.adjust') == 'object' && typeof obj.get('chart.resizable.handle.adjust')[0] == 'number' ? obj.get('chart.resizable.handle.adjust')[0] : 0);
            ca.resizing.adjustY = (typeof obj.get('chart.resizable.handle.adjust') == 'object' && typeof obj.get('chart.resizable.handle.adjust')[1] == 'number' ? obj.get('chart.resizable.handle.adjust')[1] : 0);
            ca.resizing.bgcolor = obj.get('chart.resizable.handle.background') || 'rgba(0,0,0,0)';
        }
                ...
                if (ca) {
                    ...
                    if (ca.resizing.mousedown) {
                        ...
                        var newWidth  = ca.width + (e.pageX - ca.resizing.originalx),
                            ...
                            minWidth  = obj.get('chart.resizable.minwidth'),
                            minHeight = obj.get('chart.resizable.minheight');
                        ...
                        if (newHeight > (ca.resizing.originalh / 2) && (typeof obj.get('chart.resizable.maxheight') === 'number' ? newHeight < obj.get('chart.resizable.maxheight') : true) &&
