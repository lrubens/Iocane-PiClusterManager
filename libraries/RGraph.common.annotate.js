...
(function (win, doc, undefined)
{
    ...
    RG.annotating_canvas_onmousedown = function (e)
    {
        if (e.button === 0) {
            ...
            obj.context.beginPath();
                ...
                obj.context.strokeStyle = obj.get('chart.annotatable.color');
                obj.context.lineWidth = obj.get('chart.annotatable.linewidth');
                ...
                RG.Registry.set('annotatable.actions', [obj.get('chart.annotatable.color')]);
    
                // This sets the initial X/Y position
                obj.context.moveTo(mouseX, mouseY);
                RG.Registry.set('annotatable.last.coordinates', [mouseX,mouseY]);
    ...
    */
    RG.annotating_window_onmouseup = function (e)
    {
        ...
        if (RG.Registry.get('annotatable.actions') && RG.Registry.get('annotatable.actions').length > 0 && win.localStorage) {

            var id = '__rgraph_annotations_' + e.target.id + '__';
            var annotations  = win.localStorage[id] ? win.localStorage[id] + '|' : '';
                annotations += RG.Registry.get('annotatable.actions');
        ...
        RG.Registry.set('annotatable.actions', []);
    ...
    */
    RGraph.annotating_canvas_onmousemove = function (e)
    {
        ...
        var lastXY = RG.Registry.get('annotatable.last.coordinates');
        ...
        if (obj.get('chart.mousedown')) {
            ...
            if (!lastXY) {
                ...
                obj.context.strokeStyle = obj.properties['chart.annotatable.color'];
                obj.context.moveTo(lastXY[0], lastXY[1]);
                obj.context.lineTo(mouseX, mouseY);
            }

            RG.Registry.set('annotatable.actions', RG.Registry.get('annotatable.actions') + '|' + mouseX + ',' + mouseY);
            RG.Registry.set('annotatable.last.coordinates', [mouseX,mouseY]);
        ...
        for (var i=0,len=colors.length; i<len; i+=1) {
            ...
            var div2 = doc.createElement('DIV');
                ...
                div2.onclick = function (e)
                {
                    ...
                    obj.set('chart.annotatable.color', color);
                }
